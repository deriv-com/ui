import { ComponentProps, HtmlHTMLAttributes, PropsWithChildren, } from 'react';
...
export const ModalHeader = ({ children, hideCloseIcon, className, fontSize, onRequestClose, ...rest }: PropsWithChildren<ModalHeaderProps>) => {
    return (
        <div className={clsx('deriv-modal__header', className)} {...rest}>
            <Text as='div' weight='bold' size={fontSize} className='deriv-modal__header-title'>
                {children}
            </Text>
