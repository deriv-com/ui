...
export const validPassword = (value: string) =>
    passwordRegex.isPasswordValid.test(value);

export const isPasswordValid = (password: string) => {
    return (
        passwordRegex.isPasswordValid.test(password) &&
        passwordRegex.isLengthValid.test(password)
    );
};
