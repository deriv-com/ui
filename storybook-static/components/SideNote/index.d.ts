import { ComponentProps, MouseEventHandler, PropsWithChildren, ReactNode } from '../../../node_modules/react';
 ...
 */
export declare const SideNote: ({ children, title, titleSize, className, actionClick, actionClassName, titleClassName, actionLabel, ...props }: PropsWithChildren<SideNoteProps>) => import('../../../node_modules/react').JSX.Element;
export {};
